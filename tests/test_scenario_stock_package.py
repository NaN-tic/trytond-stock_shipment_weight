...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        shipment_out.click('pack')
        self.assertEqual([(package.manual_weight, package.weight, len(package.moves)) for package in shipment_out.packages]
        , [(80.0, None, 0), (100.0, 0.0, 1), (30.0, 0.0, 1)])
        self.assertEqual(sum(package.total_weight for package in shipment_out.packages if package.parent == None)
        , 210.0)